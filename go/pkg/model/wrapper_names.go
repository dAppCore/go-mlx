...
// gemma4 e4b/26b and Mistral3 packs use) ALSO addressable by its stripped "model.…" name, so an
// assembler's bare lookups work whether or not the checkpoint nests the text model under the wrapper.
