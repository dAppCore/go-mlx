...
// subpackage. It was fixed once in pkg/metal/model, then drifted back into
// pkg/model/gemma4, which forced Mistral and pkg/native to import "gemma4" just to name a
// neutral type (g4.Arch). The model name then regrows, because new general code naturally
// lands next to Arch — in a gemma package.
//
