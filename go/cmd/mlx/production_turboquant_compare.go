...
func newProductionTurboQuantCompareReport(entries []productionTurboQuantCompareDriverReport, turns int, qualityMatch bool, qualityFlags string, normalContext bool, stressContext bool, powerWatts float64, layoutEvidence productionTurboQuantLayoutEvidenceInput) productionTurboQuantCompareReport {
	...
	evidence := mlx.ProductionTurboQuantPromotionEvidence{
		...
		BaselineInputOutputTokensPerSec:     productionCompareInputOutputTokensPerSec(baseline.Report),
		CandidateInputOutputTokensPerSec:    productionCompareInputOutputTokensPerSec(candidate.Report),
		...
		BaselineActivePlusCacheMemoryBytes:  baseline.Report.Summary.ActivePlusCacheMemoryBytes,
		CandidateActivePlusCacheMemoryBytes: candidate.Report.Summary.ActivePlusCacheMemoryBytes,
