...
func runProductionQuantizationCommand(args []string, stdout, stderr io.Writer) int {
	...
	contextLen := fs.Int("context", mlx.ProductionLaneContextLength, "requested context length")
	...
	fs.Usage = func() {
		...
		core.WriteString(stderr, "loading a model. The ladder is q8 quality, q6 default, q4\n")
		core.WriteString(stderr, "constrained fallback/control.\n")
		core.WriteString(stderr, "\n")
