...
func printUsage(w io.Writer) {
	...
	core.WriteString(w, "\n")
	core.WriteString(w, "Train a model\n")
	core.WriteString(w, "  sft                 LoRA fine-tune on {messages} targets (supervised)\n")
	core.WriteString(w, "  ssd                 LEK self-distillation — fine-tune on the model's own scored outputs\n")
	core.WriteString(w, "\n")
	...
	core.WriteString(w, "  ebook               render a model as a protected-speech EPUB3\n")
	core.WriteString(w, "\n")
