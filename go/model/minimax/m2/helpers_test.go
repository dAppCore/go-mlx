...
func TestMiniMaxM2_FirstNonEmpty_Ugly(t *testing.T) {
...
func TestMiniMaxM2_FirstPositive_Good(t *testing.T) {
	if got := firstPositive(0, -3, 7, 9); got != 7 {
		t.Fatalf("firstPositive() = %d, want first >0 value 7", got)
	}
}

func TestMiniMaxM2_FirstPositive_Bad(t *testing.T) {
...
func TestMiniMaxM2_MinPositive_Good(t *testing.T) {
...
func TestMiniMaxM2_MinPositive_Bad(t *testing.T) {
...
func TestMiniMaxM2_MinPositive_Ugly(t *testing.T) {
...
func TestMiniMaxM2_MaxPositive_Good(t *testing.T) {
