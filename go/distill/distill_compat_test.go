...
func TestDistillCompat_nonZeroDuration_Good(t *testing.T) {
...
func TestDistillCompat_nonZeroDuration_Bad(t *testing.T) {
...
func TestDistillCompat_normalizeDatasetBatchConfig_Good(t *testing.T) {
...
func TestDistillCompat_normalizeDatasetBatchConfig_Bad(t *testing.T) {
