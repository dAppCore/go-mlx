...
- [ ] **Step 4:** move the 3 orphaned tests into the gemma4 folder, change `package metal` → `package gemma4`, qualify their metal refs, fix to use the new accessors/exports.
